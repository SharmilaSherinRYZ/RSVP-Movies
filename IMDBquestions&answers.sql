...
-- here we count each table rows and took the union and we are anlysing each table
...
SELECT 'role_mapping' AS TableName,
       Count(*)       AS RowCount
FROM   role_mapping ;
/* director_mapping table has 3867 rows, genre table contains 14662 rows, movie table has 7997 rows, names have 25735, ratings has 7997
rows, role_mapping has 15615*/

-- Q2. Which columns in the movie table have null values?
-- Type your code below:
-- we inspect movie table to find null values
SELECT Sum(CASE
...
GROUP BY
    genre;
/* drama has 106.77 average_duration,fantasy has 105.14,thriller has 101.58 ,comedy has 102.62,horror has 92.72,family has 100.97,
romance has 109.53,adventure has 101.87,action has 112.88,sci-fi has 97.94,crime has 107.05,mystery has 101.80,others has 100.16*/
...
-- drama movie_count is 24,comedy 9,action 8,thriller 8,sci-fi 7,crime 6,horror 6,mystery 4,romance 4,fantasy 3,adventure 3,family 1
...
Using the top genres derived from the CTE, the directors are found whose movies have an average rating > 8 and are sorted based on 
...
/* Vijay Sethupathi total_votes 23114 movie_count 5 actor_avg_rating 8.42,Fahadh Faasil total_votes 13557  movie_count 5 
actor_avg_rating 7.99,Yogi Babu total_votes 8500 movie_count 11 actor_avg_rating 7.83,Joju George total_votes 3926 movie_count 5 
...
--------------------------------------------------------------------------------------------*/
-- Type you code below:
-- Selecting the top 9 directors with the most directed movies and storing their name_id in a CTE.
